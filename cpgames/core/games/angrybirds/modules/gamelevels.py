...
from .misc import VectorAddition, VelocityVector
...
class GameLevels():
    ...
    def loadlevelmap(self):
        ...
        for i in range(3):
            birds.append(
                Bird(screen=self.screen, images=self.resource_loader.images['bird'], loc_info=(45 * i, self.screen_size[1] - 40, 20))
            )
        if self.level_pointer == 1:
            pigs.append(
                Pig(screen=self.screen, images=self.resource_loader.images['pig'], loc_info=(1100, self.screen_size[1] - 40, 20))
            )
            pigs.append(
                Pig(screen=self.screen, images=self.resource_loader.images['pig'], loc_info=(1500, self.screen_size[1] - 40, 20))
            )
            blocks.append(
                Block(screen=self.screen, images=self.resource_loader.images['block'], loc_info=(1300, self.screen_size[1] - 60, 60))
            )
        elif self.level_pointer == 2:
            pigs.append(
                Pig(screen=self.screen, images=self.resource_loader.images['pig'], loc_info=(1000, self.screen_size[1] - 40, 20))
            )
            pigs.append(
                Pig(screen=self.screen, images=self.resource_loader.images['pig'], loc_info=(1400, self.screen_size[1] - 40, 20))
            )
            blocks.append(
                Block(screen=self.screen, images=self.resource_loader.images['block'], loc_info=(1200, self.screen_size[1] - 60, 60))
            )
            blocks.append(
                Block(screen=self.screen, images=self.resource_loader.images['block'], loc_info=(1200, self.screen_size[1] - 70, 60))
            )
            blocks.append(
                Block(screen=self.screen, images=self.resource_loader.images['block'], loc_info=(1500, self.screen_size[1] - 60, 60))
            )
        elif self.level_pointer == 3:
            pigs.append(
                Pig(screen=self.screen, images=self.resource_loader.images['pig'], loc_info=(1200, self.screen_size[1] - 60, 30))
            )
            pigs.append(
                Pig(screen=self.screen, images=self.resource_loader.images['pig'], loc_info=(1300, self.screen_size[1] - 60, 30))
            )
            blocks.append(
                Block(screen=self.screen, images=self.resource_loader.images['block'], loc_info=(1000, self.screen_size[1] - 100, 100))
            )
            blocks.append(
                Block(screen=self.screen, images=self.resource_loader.images['block'], loc_info=(1000, self.screen_size[1] - 120, 100))
            )
            blocks.append(
                Block(screen=self.screen, images=self.resource_loader.images['block'], loc_info=(1500, self.screen_size[1] - 100, 100))
            )
            blocks.append(
                Block(screen=self.screen, images=self.resource_loader.images['block'], loc_info=(1500, self.screen_size[1] - 120, 100))
            )
        elif self.level_pointer == 4:
            pigs.append(
                Pig(screen=self.screen, images=self.resource_loader.images['pig'], loc_info=(1200, 440, 30))
            )
            pigs.append(
                Pig(screen=self.screen, images=self.resource_loader.images['pig'], loc_info=(1300, self.screen_size[1] - 60, 30))
            )
            walls.append(
                Slab(screen=self.screen, images=self.resource_loader.images['wall'], x=1000, y=450, width=500, height=20)
            )
            blocks.append(
                Block(screen=self.screen, images=self.resource_loader.images['block'], loc_info=(1100, self.screen_size[1] - 100, 100))
            )
        elif self.level_pointer == 5:
            pigs.append(
                Pig(screen=self.screen, images=self.resource_loader.images['pig'], loc_info=(1300, 440, 25))
            )
            pigs.append(
                Pig(screen=self.screen, images=self.resource_loader.images['pig'], loc_info=(1300, self.screen_size[1] - 60, 25))
            )
            walls.append(
                Slab(screen=self.screen, images=self.resource_loader.images['wall'], x=500, y=400, width=100, height=self.screen_size[1]-400)
            )
            walls.append(
                Slab(screen=self.screen, images=self.resource_loader.images['wall'], x=1000, y=450, width=500, height=30)
            )
            blocks.append(
                Block(screen=self.screen, images=self.resource_loader.images['block'], loc_info=(1150, 400, 100))
            )
            blocks.append(
                Block(screen=self.screen, images=self.resource_loader.images['block'], loc_info=(1100, self.screen_size[1] - 100, 100))
            )
            ...
            walls.append(
                Slab(screen=self.screen, images=self.resource_loader.images['wall'], x=1000, y=0, width=30, height=450)
            )
            walls.append(
                Slab(screen=self.screen, images=self.resource_loader.images['wall'], x=1000, y=450, width=500, height=30)
            )
            ...
            pigs.append(
                Pig(screen=self.screen, images=self.resource_loader.images['pig'], loc_info=(1100, 440, 25))
            )
            pigs.append(
                Pig(screen=self.screen, images=self.resource_loader.images['pig'], loc_info=(1300, 440, 25))
            )
            pigs.append(
                Pig(screen=self.screen, images=self.resource_loader.images['pig'], loc_info=(1200, self.screen_size[1] - 60, 25))
            )
            walls.append(
                Slab(screen=self.screen, images=self.resource_loader.images['wall'], x=1200, y=250, width=30, height=200)
            )
            walls.append(
                Slab(screen=self.screen, images=self.resource_loader.images['wall'], x=1000, y=450, width=500, height=30)
            )
            ...
            pigs.append(
                Pig(screen=self.screen, images=self.resource_loader.images['pig'], loc_info=(1100, self.screen_size[1] - 60, 25))
            )
            pigs.append(
                Pig(screen=self.screen, images=self.resource_loader.images['pig'], loc_info=(1200, self.screen_size[1] - 60, 25))
            )
            walls.append(
                Slab(screen=self.screen, images=self.resource_loader.images['wall'], x=700, y=250, width=30, height=self.screen_size[1] - 250)
            )
            ...
            pigs.append(
                Pig(screen=self.screen, images=self.resource_loader.images['pig'], loc_info=(1450, self.screen_size[1] - 60, 25))
            )
            blocks.append(
                Block(screen=self.screen, images=self.resource_loader.images['block'], loc_info=(1250, self.screen_size[1] - 100, 100))
            )
            blocks.append(
                Block(screen=self.screen, images=self.resource_loader.images['block'], loc_info=(1250, self.screen_size[1] - 120, 100))
            )
            walls.append(
                Slab(screen=self.screen, images=self.resource_loader.images['wall'], x=700, y=400, width=30, height=self.screen_size[1] - 400)
            )
            ...
            blocks.append(
                Block(screen=self.screen, images=self.resource_loader.images['block'], loc_info=(900, self.screen_size[1] - 100, 100))
            )
            walls.append(
                Slab(screen=self.screen, images=self.resource_loader.images['wall'], x=900, y=400, width=500, height=30)
            )
            ...
            walls.append(
                Slab(screen=self.screen, images=self.resource_loader.images['wall'], x=900, y=400, width=30, height=self.screen_size[1]-400)
            )
            ...
            walls.append(
                Slab(screen=self.screen, images=self.resource_loader.images['wall'], x=1200, y=500, width=30, height=self.screen_size[1]-500)
            )
            ...
            pigs.append(
                Pig(screen=self.screen, images=self.resource_loader.images['pig'], loc_info=(1200, 340, 25))
            )
            pigs.append(
                Pig(screen=self.screen, images=self.resource_loader.images['pig'], loc_info=(1450, self.screen_size[1] - 60, 25))
            )
            ...
            blocks.append(
                Block(screen=self.screen, images=self.resource_loader.images['block'], loc_info=(900, self.screen_size[1] - 120, 100))
            )
            walls.append(
                Slab(screen=self.screen, images=self.resource_loader.images['wall'], x=900, y=400, width=500, height=40)
            )
            walls.append(
                Slab(screen=self.screen, images=self.resource_loader.images['wall'], x=1200, y=500, width=30, height=self.screen_size[1]-500)
            )
            ...
            pigs.append(
                Pig(screen=self.screen, images=self.resource_loader.images['pig'], loc_info=(1100, 340, 25))
            )
            pigs.append(
                Pig(screen=self.screen, images=self.resource_loader.images['pig'], loc_info=(1450, self.screen_size[1] - 60, 25))
            )
            ...
            blocks.append(
                Block(screen=self.screen, images=self.resource_loader.images['block'], loc_info=(1300, 300, 100))
            )
            walls.append(
                Slab(screen=self.screen, images=self.resource_loader.images['wall'], x=900, y=400, width=500, height=40)
            )
            walls.append(
                Slab(screen=self.screen, images=self.resource_loader.images['wall'], x=900, y=0, width=30, height=400)
            )
        elif self.level_pointer == 15:
            pigs.append(
                Pig(screen=self.screen, images=self.resource_loader.images['pig'], loc_info=(900, self.screen_size[1] - 60, 25))
            )
            pigs.append(
                Pig(screen=self.screen, images=self.resource_loader.images['pig'], loc_info=(self.screen_size[0] - 400, 340, 25))
            )
            pigs.append(
                Pig(screen=self.screen, images=self.resource_loader.images['pig'], loc_info=(1700, self.screen_size[1] - 60, 25))
            )
            walls.append(
                Slab(screen=self.screen, images=self.resource_loader.images['wall'], x=800, y=400, width=30, height=self.screen_size[1]-400)
            )
            walls.append(
                Slab(screen=self.screen, images=self.resource_loader.images['wall'], x=1000, y=500, width=30, height=self.screen_size[1]-500)
            )
            walls.append(
                Slab(screen=self.screen, images=self.resource_loader.images['wall'], x=self.screen_size[0]-500, y=400, width=500, height=40)
            )
            walls.append(
                Slab(screen=self.screen, images=self.resource_loader.images['wall'], x=self.screen_size[0]-500, y=150, width=60, height=250)
            )
        game_sprites = {
            'birds': birds,
            'pigs': pigs,
