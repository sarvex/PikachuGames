...
class MainInterface(pygame.sprite.Sprite):
    def __init__(self, cfg, resource_loader):
        ...
        self.image = resource_loader.images['choice']['load_game'].convert()
...
class MapButton1(pygame.sprite.Sprite):
    def __init__(self, cfg, resource_loader, position=(175, 240)):
        pygame.sprite.Sprite.__init__(self)
        self.image_1 = resource_loader.images['choice']['map1_black'].convert()
        self.image_2 = resource_loader.images['choice']['map1_red'].convert()
        self.image_3 = resource_loader.images['choice']['map1'].convert()
...
class MapButton2(pygame.sprite.Sprite):
    def __init__(self, cfg, resource_loader, position=(400, 240)):
        pygame.sprite.Sprite.__init__(self)
        self.image_1 = resource_loader.images['choice']['map2_black'].convert()
        self.image_2 = resource_loader.images['choice']['map2_red'].convert()
        self.image_3 = resource_loader.images['choice']['map2'].convert()
        self.image = self.image_1
        self.rect = self.image.get_rect()
        self.rect.center = position
    '''更新函数: 不断地更新检测鼠标是否在按钮上'''
...
class MapButton3(pygame.sprite.Sprite):
    def __init__(self, cfg, resource_loader, position=(625, 240)):
        pygame.sprite.Sprite.__init__(self)
        self.image_1 = resource_loader.images['choice']['map3_black'].convert()
        self.image_2 = resource_loader.images['choice']['map3_red'].convert()
        self.image_3 = resource_loader.images['choice']['map3'].convert()
        self.image = self.image_1
        self.rect = self.image.get_rect()
        self.rect.center = position
    '''更新函数: 不断地更新检测鼠标是否在按钮上'''
...
class EasyButton(pygame.sprite.Sprite):
    def __init__(self, cfg, resource_loader, position=(400, 150)):
        pygame.sprite.Sprite.__init__(self)
        ...
        self.text = 'easy'
        self.font = resource_loader.fonts['m04']
...
class MediumButton(pygame.sprite.Sprite):
    def __init__(self, cfg, resource_loader, position=(400, 300)):
        pygame.sprite.Sprite.__init__(self)
        self.image_1 = pygame.Surface((285, 100))
        self.image_1_front = pygame.Surface((281, 96))
        self.image_1.fill((255, 255, 255))
...
class HardButton(pygame.sprite.Sprite):
    def __init__(self, cfg, resource_loader, position=(400, 450)):
        pygame.sprite.Sprite.__init__(self)
        self.image_1 = pygame.Surface((285, 100))
        self.image_1_front = pygame.Surface((281, 96))
        self.image_1.fill((255, 255, 255))
...
class ChoiceInterface():
    def __init__(self, cfg, resource_loader):
        ...
        self.map_btn1 = MapButton1(cfg, resource_loader)
        self.map_btn2 = MapButton2(cfg, resource_loader)
        self.map_btn3 = MapButton3(cfg, resource_loader)
        self.info_box = InfoBox()
        # part2
        self.easy_btn = EasyButton(cfg, resource_loader)
        self.medium_btn = MediumButton(cfg, resource_loader)
        self.hard_btn = HardButton(cfg, resource_loader)
    '''外部调用'''
